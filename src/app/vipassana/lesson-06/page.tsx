  ...
  const practiceItems = [
    {
      ...
      object: 'รูป',
      example: 'พัดลม',
      detail: 'รูปทุกรูปที่มาปรากฏทางตา',
      icon: <FaEye />,
      color: 'text-blue-600',
    },
    {
      ...
      object: 'เสียง',
      example: 'เสียงกลอง',
      detail: 'เสียงทุกเสียงที่มาปรากฏทางหู',
      icon: <FaEarListen />,
    ...
    },
    {
      ...
      action: 'จมูกได้กลิ่น',
      object: 'กลิ่น',
      example: 'กลิ่นผัดกะเพรา',
      detail: 'กลิ่นทุกกลิ่นที่มาปรากฏทางจมูก',
      icon: <FaWind />,
    ...
    },
    {
      ...
      object: 'รส',
      example: 'รสไอติม',
      detail: 'รสทุกรสที่มาปรากฏทางลิ้น',
      icon: <FaUtensils />,
      color: 'text-rose-600',
    },
  ];
      ...
      <div className="container mx-auto px-4 max-w-4xl">
          ...
          {practiceItems.map((item, i) => (
            <IntrospectionCard key={i}>
              <div className="flex items-center gap-4 mb-6 border-b border-slate-100 pb-4">
                <div
                  className={`w-10 h-10 rounded-full flex items-center justify-center bg-slate-50 ${item.color}`}
                >
                  {item.icon}
                </div>
              ...
              <div className="space-y-6 text-xl leading-relaxed">
                <p className="font-bold text-blue-800">
                  {item.action} {item.object}ไม่เที่ยงเกิดดับ ตัวฉันไม่เที่ยงเกิดดับ
                </p>
                <p className="text-slate-600">
                  {item.example} ไม่เที่ยงเกิดดับ ตัวฉันไม่เที่ยงเกิดดับ
                </p>
                ...
                <div className="bg-blue-50 p-6 rounded-2xl border-l-4 border-dhamma-blue space-y-4">
                  ...
                  <p className="text-slate-700">
                    จริง เพราะ <span className="font-bold">{item.object}</span>มาประชุมกันชั่วคราว
                    แล้วแตกสลาย ไม่มีตัวตนเป็นของตนเอง
                  </p>
                  <p className="text-slate-700">
                    ดังนั้น {item.example} และองค์ประกอบของ{item.example} {causeRefrain}{' '}
                    <span className="text-dhamma-gold font-bold">จริงไหม...จริง</span>
                  </p>
                </div>

                <p className="text-slate-600 font-medium">
                  {item.detail} {causeRefrain} ไม่เที่ยงเกิดดับ ไม่มีตัวตนเป็นของตนเอง
                  ไม่ควรเห็นสิ่งนั้นว่าเป็นของเรา เป็นเรา เป็นตัวตนของเรา
                </p>

                <div className="pt-6 border-t border-slate-100 space-y-4">
                  <p className="text-dhamma-blue font-bold">
                    ตัวฉันไม่เที่ยงเกิดดับ ตัวฉันเป็นเพียงรูป {causeRefrain}{' '}
                    <span className="text-dhamma-gold font-bold">จริงไหม...จริง</span>
                  </p>
                  <p className="text-slate-600">
                    จริงอย่างไร? อวัยวะภายใน ภายนอก ดีใจ เสียใจ ความสุข ความทุกข์ การกระทำ
                    ความคิดเห็น นั่งนอน ไปไหนมาไหน {causeRefrain}{' '}
                    <span className="text-dhamma-gold font-bold">จริงไหม...จริง</span>
                  </p>
                </div>
              </div>
        ...
        <IntrospectionCard>
          ...
          <div className="space-y-6 text-xl leading-relaxed">
            ...
            <p className="text-slate-500 italic">
              เย็น{causeRefrain} ตัวฉันไม่เที่ยงเกิดดับ {selfRefrain}
            </p>
            <div className="bg-blue-50 p-6 rounded-2xl border-l-4 border-dhamma-blue">
              ...
              <p className="text-slate-700">
                จริง เพราะ สัมผัสมาประชุมกันชั่วคราว แล้วแตกสลาย ไม่มีตัวตนเป็นของตนเอง
              </p>
              <p className="text-slate-700 mt-2">
                สัมผัส เย็น ร้อน อ่อน แข็ง ตึง ไหว {causeRefrain}{' '}
                <span className="text-dhamma-gold font-bold">จริงไหม...จริง</span>
              </p>
            </div>
          </div>
        ...
        <IntrospectionCard>
          ...
          <div className="space-y-6 text-xl leading-relaxed">
            ...
            <p className="text-slate-500 italic">
              ความคิด{causeRefrain} ตัวฉันไม่เที่ยงเกิดดับ {selfRefrain}
            </p>
            <div className="bg-blue-50 p-6 rounded-2xl border-l-4 border-dhamma-blue">
              <p className="font-bold text-dhamma-blue mb-2">จริงไหม...จริง จริงอย่างไร?</p>
              <p className="text-slate-700">
                จริง เพราะ ความคิดมาประชุมกันชั่วคราว แล้วแตกสลาย ไม่มีตัวตนเป็นของตนเอง
              </p>
              <p className="text-slate-700 mt-2 italic">
                คิดถึงคน คนก็{causeRefrain} คิดถึงตนเอง ตนเองก็{causeRefrain} คิดถึงสิ่งของ
                สิ่งของก็{causeRefrain}{' '}
                <span className="text-dhamma-gold font-bold">จริงไหม...จริง</span>
              </p>
            </div>
          </div>
        ...
        <div className="space-y-8 mb-16">
          <h4 className="text-center text-slate-400 font-medium mb-8 uppercase tracking-widest">
            บทสรุปการพิจารณาอินทรีย์ 6
          </h4>
          {finalSenses.map((s, i) => (
            <IntrospectionCard key={i}>
              <div className="flex items-center gap-4 mb-6">
                <div
                  className={`w-10 h-10 rounded-full flex items-center justify-center bg-slate-100 ${s.color}`}
                >
                  {s.icon}
                </div>
                <p className="text-2xl font-bold text-slate-800">
                  {s.action} {s.object !== 'สัมผัส' && s.object !== 'ความคิด' ? s.object : ''}
              ...
              <div className="space-y-4 text-xl text-slate-600 leading-relaxed">
                ...
                <p className="text-blue-700 font-medium">
                  ตัวฉันไม่เที่ยงเกิดดับ ตัวฉัน{causeRefrain}
                </p>
                <p className="pt-4 border-t border-slate-100">
                  <span className="font-bold text-slate-800">{s.object}</span>
                  {anattaRefrain}
                </p>
              </div>
            </IntrospectionCard>
