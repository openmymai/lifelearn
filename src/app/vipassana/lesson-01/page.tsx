...
export default function Lesson0101() {
  ...
  const sensesRefrain = "เป็นธรรมชาติชนิดหนึ่ง เกิดจากเหตุปัจจัย มาประชุมปรุงแต่งชั่วคราว แล้วแตกสลาย ไม่เที่ยง เป็นทุกข์ เป็นอนัตตา ไม่มีตัวตนเป็นของตนเอง ไม่ควรไปยึดมั่นถือมั่นว่า สิ่งนั้นเป็นของเรา เป็นเรา เป็นตัวตนของเรา ไม่เที่ยงเกิดดับ";
  
  // Refrain สำหรับขันธ์ 5 (ไม่มี ไม่เที่ยง เป็นทุกข์ เป็นอนัตตา)
  const aggregatesRefrain = "ทั้งหมดเป็นธรรมชาติชนิดหนึ่ง เกิดจากเหตุปัจจัย มาประชุมปรุงแต่งชั่วคราว แล้วแตกสลาย ไม่มีตัวตนเป็นของตนเอง ไม่ควรไปยึดมั่นถือมั่น ว่าสิ่งนั้นเป็นของเรา เป็นเรา เป็นตัวตนของเรา ไม่เที่ยงเกิดดับ";
    ...
    <div className="bg-slate-50 min-h-screen py-16">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-slate-800 mt-2 mb-4 font-prompt">พิจารณาขันธ์ 5 และอินทรีย์ 6</h2>
        ...
        <div className="space-y-4 mb-12">
          <h4 className="text-center text-slate-400 font-medium mb-8 uppercase tracking-tighter">พิจารณาอินทรีย์ 6 โดยละเอียด</h4>
          {detailedSenses.map((item, i) => (
            <IntrospectionCard key={i}>
              ...
              <div className="space-y-6 text-xl text-slate-600 leading-relaxed">
                ...
                <p>
                  <span className="font-bold text-slate-800">{item.object}</span>{sensesRefrain}
                </p>

                {/* พิจารณาตัวผู้รู้ (ตัวฉัน) - เพิ่มใหม่ตามคำแนะนำ */}
                <div className="pt-4 border-t border-slate-50">
                  <p>
                    <span className="font-bold text-blue-700">ตัวฉัน</span>{sensesRefrain}
                  </p>
                </div>
              </div>
            </IntrospectionCard>
        ...
        <div className="space-y-4 mb-12">
          <h4 className="text-center text-slate-400 font-medium mb-8 uppercase tracking-tighter">พิจารณาขันธ์ 5</h4>
          {aggregates.map((item, i) => (
            <IntrospectionCard key={i}>
              ...
              <p className="text-xl text-slate-600 leading-relaxed">
                อย่างใดอย่างหนึ่ง ที่เป็นอดีต อนาคต และปัจจุบัน ภายในหรือภายนอก หยาบหรือละเอียด เลวหรือประณีต ไกลหรือใกล้ {aggregatesRefrain}
              </p>
            </IntrospectionCard>
          ))}
        </div>
