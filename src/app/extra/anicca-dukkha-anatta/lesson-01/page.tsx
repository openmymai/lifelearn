// src/app/extra/lesson-01/page.tsx
...
export default function ExtraLesson01() {
  const sensesData = [
  ...
  const refrain = (
    <div className="space-y-4 mt-4">
      <p className="text-slate-700 font-medium">สิ่งใดไม่เที่ยงสิ่งนั้นเป็นทุกข์</p>
      <p className="text-slate-700 font-medium">สิ่งใดเป็นทุกข์สิ่งนั้นเป็นอนัตตา</p>
      <p className="text-slate-500 italic">สิ่งนั้นท่านทั้งหลาย พึงเห็นด้วยปัญญา อันชอบตามความเป็นจริง อย่างนี้ว่า</p>
      <div className="bg-emerald-50/50 p-6 rounded-2xl border-l-4 border-emerald-500 space-y-3">
        ...
        <p className="text-emerald-800 font-bold underline decoration-2 underline-offset-4">ว่างเปล่าจากตน หรือจากของๆตน</p>
      </div>
    </div>
  );
    ...
    <div className="bg-slate-50 min-h-screen py-16">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-slate-800 mt-2 mb-4 font-prompt">ความเป็นอนิจจังแห่งอายตนะภายใน</h2>
          <p className="text-slate-500 text-lg italic">"จักษุเป็นของไม่เที่ยง..."</p>
          ...
          {sensesData.map((s, i) => (
            <IntrospectionCard key={i}>
              <div className="flex items-center gap-4 mb-6 border-b border-slate-100 pb-5">
                ...
                <h3 className="text-2xl font-bold text-slate-800">{s.name}เป็นของไม่เที่ยง</h3>
              </div>
          ...
          <IntrospectionCard highlight={true}>
            <div className="flex flex-col items-center text-center space-y-8 py-4">
              ...
              <div className="bg-white/10 p-8 rounded-3xl border border-white/20 w-full space-y-4">
                ...
                <p className="text-2xl font-bold text-white">เมื่อหลุดพ้นแล้ว ย่อมมีญาณหยั่งรู้ว่าหลุดพ้นแล้ว</p>
              </div>
        ...
        <div className="mt-20 text-center">
          <Link 
            href="/extra/anicca-dukkha-anatta/lesson-02" 
          ...
          >
            บทเรียนถัดไป: ความเป็นทุกข์แห่งอายตนะภายใน
            <FaArrowRight />
          </Link>
        </div>
