// src/app/extra/anicca-dukkha-anatta/lesson-05/page.tsx
...
export default function ExtraLesson05() {
    ...
    <div className="bg-slate-50 min-h-screen py-16">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-slate-800 mt-2 mb-4 font-prompt">ความเป็นทุกข์แห่งอายตนะภายนอก</h2>
          <p className="text-slate-500 text-lg italic">"รูปเป็นทุกข์..."</p>
        ...
        <IntrospectionCard>
          <div className="flex items-center gap-4 mb-6 border-b border-slate-100 pb-5">
            ...
            <h3 className="text-2xl font-bold text-slate-800">รูปเป็นทุกข์</h3>
          </div>
          <div className="space-y-4 text-xl md:text-2xl leading-relaxed text-slate-700">
            <p>สิ่งใดเป็นทุกข์สิ่งนั้นเป็นอนัตตา</p>
            <p className="text-slate-500 italic text-lg">สิ่งใดเป็นอนัตตาสิ่งนั้นท่านทั้งหลาย พึงเห็นด้วยปัญญา อันชอบตามความเป็นจริง อย่างนี้ว่า</p>
            {insightRefrain}
          </div>
        </IntrospectionCard>
        ...
        <IntrospectionCard>
          ...
          <div className="space-y-4 text-xl md:text-2xl leading-relaxed text-slate-700">
            <p>เป็นทุกข์</p>
            <p>สิ่งใดเป็นทุกข์สิ่งนั้นเป็นอนัตตา</p>
            <p className="text-slate-500 italic text-lg">สิ่งใดเป็นอนัตตา สิ่งนั้นท่านทั้งหลาย พึงเห็นด้วยปัญญา อันชอบตามความเป็นจริง อย่างนี้ว่า</p>
            {insightRefrain}
          </div>
        </IntrospectionCard>
        ...
        <div className="mt-20 text-center">
          <Link 
            href="/extra/anicca-dukkha-anatta/lesson-06" 
          ...
          >
            บทเรียนถัดไป: ความเป็นอนัตตาแห่งอายตนะภายนอก
            <FaArrowRight />
          </Link>
        </div>
