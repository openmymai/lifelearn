// src/app/extra/anicca-dukkha-anatta/lesson-06/page.tsx
...
export default function ExtraLesson06() {
    ...
    <div className="bg-slate-50 min-h-screen py-16">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-slate-500 text-lg italic">"รูปเป็นอนัตตา..."</p>
        ...
        <IntrospectionCard>
          <div className="flex items-center gap-4 mb-6 border-b border-slate-100 pb-5">
            ...
            <h3 className="text-2xl font-bold text-slate-800">รูปเป็นอนัตตา</h3>
          </div>
        ...
        <div className="mt-20 text-center">
          <Link 
            href="/extra/anicca-dukkha-anatta/lesson-07" 
