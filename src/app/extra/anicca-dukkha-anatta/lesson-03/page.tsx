// src/app/extra/anicca-dukkha-anatta/lesson-03/page.tsx
...
export default function ExtraLesson03() {
  const sensesData = [
  ...
  const refrain = (
    <div className="space-y-4 mt-4">
      ...
      <div className="bg-emerald-50/50 p-6 rounded-2xl border-l-4 border-emerald-500 space-y-3 shadow-inner">
        ...
        <p className="text-emerald-700 font-bold">ไม่ควรเห็นว่าสิ่งนั้นเป็นของเรา เป็นเรา เป็นตัวตนของเรา ไม่เที่ยงเกิดดับ ดับไม่เหลือ</p>
        <p className="text-emerald-800 font-bold underline decoration-2 underline-offset-4">ว่างเปล่าจากตนหรือจากของๆตน</p>
      </div>
    </div>
  );
    ...
    <div className="bg-slate-50 min-h-screen py-16">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-slate-800 mt-2 mb-4 font-prompt">ความเป็นอนัตตาแห่งอายตนะภายใน</h2>
          <p className="text-slate-500 text-lg italic">"จักษุเป็นอนัตตา..."</p>
          ...
          {sensesData.map((s, i) => (
            <IntrospectionCard key={i}>
              <div className="flex items-center gap-4 mb-6 border-b border-slate-100 pb-5">
                ...
                <h3 className="text-2xl font-bold text-slate-800">{s.name}เป็นอนัตตา</h3>
              </div>
        ...
        <div className="mt-20 text-center">
          <Link 
            href="/extra/anicca-dukkha-anatta/lesson-04" 
          ...
          >
            บทเรียนถัดไป: ความเป็นอนิจจังแห่งอายตนะภายนอก
            <FaArrowRight />
          </Link>
        </div>
