...
const Hero = () => {
  ...
  useEffect(() => {
    const options = {
      strings: ['ตัวเราเป็นใคร?', 'เกิดมาทำไม?', 'เป้าหมายชีวิตของเราอยู่ที่ไหน?'],
      typeSpeed: 60,
      backSpeed: 40,
      loop: true,
      backDelay: 1500,
  ...
  return (
    <section
      id="hero"
      className="relative overflow-hidden bg-linear-to-b from-blue-50 to-white min-h-[90vh] flex items-center"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1 text-center lg:text-left">
            ...
            <div className="h-16 md:h-20 mb-8">
              <span ref={el} className="text-2xl md:text-3xl text-slate-600 font-light italic" />
            </div>
            ...
            <div className="space-y-6">
              ...
              <Link href="/buddhateaching" className="block group">
